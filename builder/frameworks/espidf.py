...
def extract_linker_script_fragments(framework_components_dir, sdk_config):
    ...
    result.extend(
        [
            os.path.join(framework_components_dir, "esp_common", "common.lf"),
            os.path.join(framework_components_dir, "esp_common", "soc.lf"),
            os.path.join(framework_components_dir, "esp_system", "app.lf"),
            os.path.join(framework_components_dir, "newlib", "newlib.lf"),
            os.path.join(framework_components_dir, "newlib", "system_libs.lf"),
        ]
    )
